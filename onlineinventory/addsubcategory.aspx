<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addsubcategory.aspx.cs" Inherits="onlineinventory.addsubcategory" %>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6 col-12">
					    ...
					    <label>Subcategory Name</label>
							<asp:TextBox ID="txtsubcatgory" CssClass="form-control" runat="server"></asp:TextBox>
						</div>
					</div>
					<div class="col-lg-12">
				<div class="form-group">
					...
					<div class="col-lg-12">
							...
							<asp:Button ID="btnupdate" class="btn btn-success me-2" runat="server" Text="Update" />
						     ...
						     <a href="brand.aspx" class="btn btn-dark me-2">Cancel</a>
					</div>
