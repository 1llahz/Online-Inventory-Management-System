<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addpayment.aspx.cs" Inherits="onlineinventory.addpayment" %>
...
<body>
				 ...
				 <div class="card-body">
					...
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-lg-10 col-sm-10 col-10">
                                        <asp:DropDownList ID="ddlcustname" CssClass="form-control" runat="server">
								...
								<div class="add-icon">
								<asp:Button ID="btngetproData" formnovalidate="" class="btn btn-primary me-2 " runat="server" Text="Get" OnClick="btngetproData_Click" />
								</div>
							  </div>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<asp:DropDownList ID="ddlproname" CssClass="form-control" runat="server">
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<div class="input-groupicon">
									 <asp:TextBox ID="txtqty"  class="form-control" placeholder="Enter quantity" readonly="true" required="" runat="server" ></asp:TextBox>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>Price</label>
								   <asp:TextBox ID="txtprice"  class="form-control" placeholder="Enter price" readonly="true" required="" runat="server" ></asp:TextBox>
							</div>
						</div>
						<div class="row">
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<asp:TextBox ID="txtnqty" onkeyup="sub()"  class="form-control" placeholder="Enter new quantity" required="" runat="server" ></asp:TextBox>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>Remained quantity</label>
								 <asp:TextBox ID="txtremained"  class="form-control" readonly="true" placeholder="Enter remained quantity" required="" runat="server" ></asp:TextBox>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>New price</label>
								 <asp:TextBox ID="txtnewprice"  class="form-control" onkeyup="mult()"  placeholder="Enter new price " required="" runat="server"  ></asp:TextBox>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								<label>New balance</label>
								 <asp:TextBox ID="txtnbalance"  class="form-control"  placeholder="Enter new balance " readonly="true" required="" runat="server" ></asp:TextBox>
						...
						<div class="col-lg-12">
							<div class="col-lg-12">
								...
								<asp:Button ID="btnupdate" class="btn btn-success me-2" runat="server" Text="Update" />
								 <asp:Button ID="btndelete" class="btn btn-danger me-2" formnovalidate="" runat="server" Text="Delete"  />

								 <a href="purchaselist.aspx" class="btn btn-dark me-2">Cancel</a>
						</div>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-s2 form-group"></div>
						 ...
						 <asp:Button ID="btnsearch"  class="btn btn-info" formnovalidate="" runat="server" Text="search" />
					</div>
			</div>
	...
	<!-- funtions starts here -->
     ...
     function sub() {
         let Quantity = document.querySelector("#txtqty").value;
         let NewQuantity = document.querySelector("#txtnqty").value;

             let Total = document.querySelector("#txtremained").value = Quantity - NewQuantity;
         
     }

     function mult() {
         let NewQuantity = document.querySelector("#txtnqty").value;
         let NewPrice = document.querySelector("#txtnewprice").value;

         if (NewQuantity < 0 || NewPrice < 0) {
             alert("New quantity and price cannot be negative.");
             document.querySelector("#txtnqty").value = 0;
             document.querySelector("#txtnewprice").value = 0;
         } else {
             let Balance = document.querySelector("#txtnbalance").value = NewQuantity * NewPrice;
         }
     }
