<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addsupplier.aspx.cs" Inherits="onlineinventory.addsupplier" %>
...
<body>
			...
			<div class="header">
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item" href="signin.aspx">Logout</a>
					</div>
				</div>
				<!-- /Mobile Menu -->
			</div>
	...
	<form id="form1" runat="server">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6 col-12">
						<div class="form-group">
							 <label>City</label>
							   ...
							   <asp:ListItem > Mogadishu</asp:ListItem>
                               <asp:ListItem > london</asp:ListItem>
							   <asp:ListItem > New york</asp:ListItem>
                               <asp:ListItem > Ottawa</asp:ListItem>
                               <asp:ListItem >Beijin </asp:ListItem>
					...
					<div class="col-lg-12">
							...
							<asp:Button ID="btnupdate" class="btn btn-success me-2" runat="server" Text="Update" OnClick="btnupdate_Click" />
						     ...
						     <a href="productlist.aspx" class="btn btn-dark me-2">Cancel</a>
					</div>
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString4 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString4.ProviderName %>' SelectCommand="SELECT * FROM [addsupplier]"></asp:SqlDataSource>
    </form>
	</div>
</div>
