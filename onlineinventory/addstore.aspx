<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addstore.aspx.cs" Inherits="onlineinventory.addstore" %>
	...
	<div class="card-body">
		<div class="row">
			...
			<div class="col-lg-3 col-sm-6 col-12">
				...
				<asp:TextBox ID="txtstorename" CssClass="form-control" runat="server" placeholder="Enter store name" required=""></asp:TextBox>
				</div>
				<div class="form-group">
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString6 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString6.ProviderName %>' SelectCommand="SELECT * FROM [addstore]"></asp:SqlDataSource>
    </form>
