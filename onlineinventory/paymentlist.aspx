<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paymentlist.aspx.cs" Inherits="onlineinventory.paymentlist" %>
...
<div class="page-wrapper">
	<div class="content">
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="addpayment.aspx" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-1"/>Add Payments</a>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
             ...
             <asp:GridView ID="GridView2" runat="server" CssClass="table table-bordered table-sm table-hover" DataSourceID="SqlDataSource2"></asp:GridView>

             <asp:SqlDataSource runat="server" ID="SqlDataSource2"  ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString14 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString14.ProviderName %>' SelectCommand="SELECT a.payid, c.custname, p.productname,a.qty,a.price,a.newqty,a.remainedqty,a.newprice,a.totalbalance,a.registerdate
				FROM addpayments a join customers c on a.custid = c.custid JOIN addproduct p ON a.productid = p.productid;"></asp:SqlDataSource>
         </form>
		<!-- /product list -->
	</div>
</div>
