<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addpurchase.aspx.cs" Inherits="onlineinventory.addpurchase" %>
...
<body>
						...
						<a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
							<span class="user-info">
								<span class="user-letter">
									<img src="Taroo Icon.jpeg" alt="" class="user-avatar-md rounded-circle"/>
								</span>
	...
	<div class="content">
             ...
             <div class="card">
				 <div class="card-body">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-lg-10 col-sm-10 col-10">
                                        <asp:DropDownList ID="ddlsup" CssClass="form-control" runat="server">
                                            <asp:ListItem>select suppliers</asp:ListItem>
                                        </asp:DropDownList>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<div class="input-groupicon">
									<asp:TextBox ID="txtpdate"  placeholder="DD-MM-YYYY"  textmode="date" CssClass="form-control" runat="server"></asp:TextBox>
					...
					<div class="image-upload">
						<asp:FileUpload ID="txtfdoc"  CssClass="form-control" runat="server" />
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<asp:TextBox ID="txtotax" CssClass="form-control" runat="server"></asp:TextBox>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<asp:TextBox ID="txtship" CssClass="form-control" runat="server"></asp:TextBox>
							</div>
						</div>
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
		...
		<!-- /add -->
                     ...
                     <asp:GridView ID="GridView1" CssClass="table table-bordered table-sm table-hover"  runat="server" DataSourceID="SqlDataSource1"></asp:GridView>


                     <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString5 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString5.ProviderName %>' SelectCommand="SELECT * FROM [addpurchase]"></asp:SqlDataSource>
                 </div>
             </div>
