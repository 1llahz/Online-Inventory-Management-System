<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="saleslist.aspx.cs" Inherits="onlineinventory.saleslist" %>
...
<div class="page-wrapper">
	<div class="content">
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="addsales.aspx" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-1"/>Add Sales</a>
			</div>
		</div>
 ...
 <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString13 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString13.ProviderName %>' SelectCommand=" SELECT a.saleid, c.custname, s.suppname,a.salesdate,a.ordertax,a.discount,a.shipping,a.status,a.describtion
	FROM addsales a join customers c on a.custid = c.custid JOIN addsupplier s ON a.suppid = s.suppid"></asp:SqlDataSource>
