<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subcategorylist.aspx.cs" Inherits="onlineinventory.subcategorylist" %>
...
<div class="page-wrapper">
	<div class="content">
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="addsubcategory.aspx" class="btn btn-added">
					<img src="assets/img/icons/plus.svg"  class="me-1" alt="img"/>Add  SubCategory
				</a>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
             ...
             <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString10 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString10.ProviderName %>' SelectCommand="SELECT * FROM [addsubcategory]"></asp:SqlDataSource>
         </form>
		<!-- /product list -->
	</div>
</div>
