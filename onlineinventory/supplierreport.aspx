<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="supplierreport.aspx.cs" Inherits="onlineinventory.supplierreport" %>
...
<!-- /product list -->
         ...
         <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString12 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString12.ProviderName %>' SelectCommand="SELECT * FROM [addsupplier]"></asp:SqlDataSource>
     </form>
