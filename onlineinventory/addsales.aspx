<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addsales.aspx.cs" Inherits="onlineinventory.addsales" %>
						...
						<div class="col-lg-3 col-sm-6 col-12">
							<div class="form-group">
								...
								<div class="input-groupicon">
									<asp:TextBox ID="txtpdate"  placeholder="Choose Date" textmode="date" class="datetimepicker" CssClass="form-control" runat="server"></asp:TextBox>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="col-lg-12">
						...
						<asp:Button ID="btnsubmit" class="btn btn-primary me-2 " runat="server" Text="Submit" OnClick="btnsubmit_Click1"   />
