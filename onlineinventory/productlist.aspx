<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productlist.aspx.cs" Inherits="onlineinventory.productlist" %>
...
<body>
	...
	<div class="content">
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="addproduct.aspx" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-1"/>Add New Product</a>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
             ...
             <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-sm table-hover" DataSourceID="SqlDataSource1"></asp:GridView>

             <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString11 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString11.ProviderName %>' SelectCommand="select a.productid, c.catgname, b.brandname,s.subcatgname, a.productname, a.unit ,a.minimumqty, a.describtion, a.discounttype, a.status ,a.sku, a.qty, a.price,  a.registerdate  from addproduct a
			join addcategory c on a.catgid = c.catgid join addbrand b on a.brandid = b.brandid join addsubcategory s on a.subcatgid = s.subcatgid"></asp:SqlDataSource>
         </form>
		<!-- /product list -->
	</div>
</div>
