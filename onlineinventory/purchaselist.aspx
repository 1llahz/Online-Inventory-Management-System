<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purchaselist.aspx.cs" Inherits="onlineinventory.purchaselist" %>
...
<body>
	...
	<div class="content">
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="addpurchase.aspx" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img"/>Add Purchase</a>
			</div>
		</div>
...
<!-- /product list -->
		     ...
		     <asp:GridView ID="GridView2" CssClass="table table-bordered table-sm table-hover"  runat="server" DataSourceID="SqlDataSource2"></asp:GridView>

  <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString8 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString8.ProviderName %>' SelectCommand="SELECT a.purid, s.suppname, p.productname,a.purchasedate,a.refrenceno,a.ordertax,a.discount,a.shipping,a.status,a.describtion
	FROM addpurchase a JOIN addsupplier s ON a.suppid = s.suppid JOIN addproduct p ON a.productid = p.productid;"></asp:SqlDataSource>
