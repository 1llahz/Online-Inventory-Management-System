<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcategory.aspx.cs" Inherits="onlineinventory.addcategory" %>
...
<div class="sidebar" id="sidebar">
	...
	<div class="content">
		<div class="page-header">
			<div class="page-title">
				<h4>Product add category Form </h4>
	...
	<form id="form1" runat="server">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6 col-12">
						<div class="form-group">
							...
							<asp:TextBox ID="txtcatgcode" CssClass="form-control"  runat="server"></asp:TextBox>
						</div>
					</div>
					<div class="col-lg-12">
						<div class="form-group">
					...
					<div class="col-lg-12">
							...
							<asp:Button ID="btnupdate" class="btn btn-success me-2" runat="server" Text="Update" OnClick="btnupdate_Click"/>
						     ...
						     <a href="categorylist.aspx" class="btn btn-dark me-2">Cancel</a>
					</div>
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString2 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString2.ProviderName %>' SelectCommand="SELECT * FROM [addcategory]"></asp:SqlDataSource>
    </form>
	</div>
</div>
