<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcustomer.aspx.cs" Inherits="onlineinventory.addcustomer" %>
...
<body>
	...
	<form id="form1" runat="server">
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:Inventory_dbConnectionString3 %>' ProviderName='<%$ ConnectionStrings:Inventory_dbConnectionString3.ProviderName %>' SelectCommand="SELECT * FROM [customers]"></asp:SqlDataSource>
