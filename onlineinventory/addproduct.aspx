<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addproduct.aspx.cs" Inherits="onlineinventory.addproduct" %>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6 col-12">
						<div class="form-group">
							...
							<asp:TextBox ID="txtminqty"   class="form-control"  runat="server"></asp:TextBox>				
					...
					<div class="col-lg-3 col-sm-6 col-12">
						<div class="form-group">
							<label>Discount Type</label>
								<asp:DropDownList ID="ddldiscount"  CssClass="form-control" runat="server" >
								<asp:ListItem > Select  discount </asp:ListItem>	
